  ...
  return (
    <section id="about" className="page-gutter pb-20">
      <div className="max-w-[1280px] mx-auto">
        <FadeIn>
          <div className="bg-accent-yellow rounded-[48px] h-[750px] flex flex-col items-center justify-center px-8 md:px-[15%] text-center">
            <h2 className="text-[48px] font-bold text-ink">关于我们</h2>
            <p className="mt-6 text-2xl text-ink/80 leading-[1.5] max-w-[680px]">
